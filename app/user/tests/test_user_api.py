...
class PublicUserApiTests(TestCase):
    ...
    def test_user_with_email_exists_error(self):
        """Test error returned if creating user with email already exists."""
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
            'name': 'Test Name'
    ...
    def test_password_too_short_error(self):
        """Test returns error if password less than 5 characters."""
        payload = {
            'email': 'test@example.com',
            'password': 'pw',
            'name': 'Test Name'
    ...
    def test_create_token_for_bad_credentials_error(self):
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        self.user.refresh_from_db() # To refresh the value of the user in the database after updating the values.
